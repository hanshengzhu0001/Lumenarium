...
manifest="/tmp/sceneproof_fix76_com_action_smoke1_fix78.txt"
audit_root="$root/sceneba_audit/$candidate/true_mesh_com_smoke1_fix78"
log_root="logs/sceneproof_fix76_com_action_smoke1_fix78"
...
action_audit="$audit_root/com_action_audit.json"
...
echo "FIX78_RESPONSIBILITY=$(readlink -f "$audit_root/responsibility.json")"
echo "FIX78_ACTION_AUDIT=$(readlink -f "$action_audit")"
echo "FIX78_REPORT=$(readlink -f "$audit_root/responsibility.txt")"
